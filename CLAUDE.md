...
A personal blog ("華生的珈琲館") built with Hugo and the PaperMod theme. Content is in Traditional Chinese (zh-TW), covering history, geography, and typography. Deployed to GitHub Pages at https://watsonhugo.github.io/.
...
- **Install theme:** `git submodule update --init --recursive` (PaperMod is a git submodule)
...
- **layouts/**, **assets/**, **data/**, **i18n/** — Override directories (currently empty; used to customize PaperMod without modifying the submodule)
